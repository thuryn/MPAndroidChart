...
import org.thosp.charting.buffer.BarBuffer;
...
import org.thosp.charting.highlight.Range;
import org.thosp.charting.interfaces.dataprovider.BarDataProvider;
...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        Transformer trans = mChart.getTransformer(dataSet.getAxisIndex());
        ...
        buffer.setInverted(mChart.isInverted(dataSet.getAxisIndex()));
        ...
        final boolean isInverted = mChart.isInverted(dataSet.getAxisIndex());
    ...
    public void drawValues(Canvas c) {
        ...
        if (isDrawingValuesAllowed(mChart)) {
            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                boolean isInverted = mChart.isInverted(dataSet.getAxisIndex());
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            Transformer trans = mChart.getTransformer(set.getAxisIndex());
